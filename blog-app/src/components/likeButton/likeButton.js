...
class LikeButton extends React.Component {
  ...
  render() {
    return (
      <div className="theLikeButton">
        <button onClick={this.like.bind(this)}>
          Purdy! &#128077; {this.state.likes}
        </button>
        <button onClick={this.dislike.bind(this)}>
          What in tarnation!&#x1f44e; {this.state.dislikes}
        </button>
      </div>
    );
  }
